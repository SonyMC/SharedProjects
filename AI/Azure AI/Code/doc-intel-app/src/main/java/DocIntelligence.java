/* 
 * Refer: https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/quickstarts/get-started-sdks-rest-api?view=doc-intel-4.0.0&pivots=programming-language-java
*/
...
public class DocIntelligence {
  ...
  // set `<your-endpoint>` and `<your-key>` variables with the values from the Azure portal
      ...
      /*
    Note : Create document intelligence  instance before running this and update the key and endpoint
    */

  private static final String endpoint = "https://xxx.azure.com/";
